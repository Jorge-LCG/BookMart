    ...
    <div class="flex items-center justify-center my-15 px-3">
        <div class="w-full max-w-md">
            ...
            <form class="w-full mt-4" action="{{ route('login.store') }}" method="POST">
                ...
                <a href="{{ route('password') }}" class="text-sm font-medium hover:text-gray-800 transition-colors duration-300">
                ...
                <a href="{{ route('register') }}" class="text-sm font-medium block mt-3 hover:text-gray-800 transition-colors duration-300">
                    ¿No tienes una cuenta? <span class="text-orange-500 font-semibold hover:text-orange-600">Regístrate</span>
                </a>
            </form>
        </div>
    </div>
