        ...
        <div class="w-full max-w-md">
            ...
            <form class="w-full mt-4" action="{{ route('claims.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select id="tipo_reclamo" name="tipo_reclamo" class="cursor-pointer w-full p-2 border rounded-lg text-sm">
                ...
                <div class="mb-3">
                    ...
                    <textarea 
                        name="description" 
                        id="description"
                        class="w-full h-32 text-sm border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500 @error('description') border-red-500 @enderror"
                    ></textarea>
                    @error('description')
                        <p class="text-sm text-red-600">{{ $message }}</p>
                    @enderror
