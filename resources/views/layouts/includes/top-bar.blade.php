    ...
    <div class="container mx-auto flex flex-col items-center md:flex-row md:justify-between">
        <div class="flex text-sm pt-4 md:p-4 items-center">
            <p class="flex gap-1.5 items-center border-r border-gray-300">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#F7941D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-headset">
                ...
                <span class="mr-2 text-gray-700">+060 (800) 801-582</span>
            </p>
            <p class="flex gap-1.5 items-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#F7941D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-message ml-2">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                    <path d="M8 9h8" />
                    <path d="M8 13h6" />
                    <path d="M18 4a3 3 0 0 1 3 3v8a3 3 0 0 1 -3 3h-5l-5 3v-3h-2a3 3 0 0 1 -3 -3v-8a3 3 0 0 1 3 -3h12z" />
                </svg>
                <span class="text-gray-700">support@bookmart.com</span>
            </p>
        </div>
    
        <div class="flex text-sm p-4 items-center">
            <form>
                <button class="flex gap-1.5 items-center border-r border-gray-300 cursor-pointer group">
            ...
            <form>
                <button class="flex gap-1.5 items-center cursor-pointer group">
